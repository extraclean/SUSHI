...
\title{A Path Planning of Mobile Beacon-Assisted Localization Based on Scanning by Unit Square for Wireless Sensor Networks}

% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Wen-Dar Cheng}
\IEEEauthorblockA{Institute of Manufacturing\\Information and Systems.\\National Cheng Kung University.\\Taiwan.\\P96031123@mail.ncku.edu.tw}
\and
\IEEEauthorblockN{Pei-Hsuan Tsai}
\IEEEauthorblockA{Institute of Manufacturing\\Information and Systems.\\National Cheng Kung University.\\Taiwan.\\phtsai@mail.ncku.edu.tw}
\and
\IEEEauthorblockN{Rong-Guei Tsai}
\IEEEauthorblockA{Institute of Manufacturing\\Information and Systems.\\National Cheng Kung University.\\Taiwan.\\P98031056@mail.ncku.edu.tw}}
